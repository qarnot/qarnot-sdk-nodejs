...
class Profile extends Resource {
   ...
   * see: {@link https://computing.qarnot.com/documentation/api/#api-Profiles-Profiles}
   * @function
   * @name list
   * @memberof profiles
   * @example <caption>Usage</caption>
   * const ss = await Qarnot.profiles.list();
   ...
   * see: {@link https://computing.qarnot.com/documentation/api/#api-Profiles-Profile_details}
   * @function
   * @name get
   * @memberof profiles
