...
class Pool extends Resource {
   ...
   * see: {@link https://computing.qarnot.com/documentation/api/#api-Pools-Update_pool's_resources}
   * @memberof pools
   * @function
   * @name updateResources
   * @param uuid {String} uuid of the pool
   ...
   * see: {@link https://computing.qarnot.com/documentation/api/#api-Pool-Last_Task_Std_Err}
   * @memberof pools
   * @function
   * @name lastStderr
   * @param uuid {String} uuid of the pool
   ...
   * see: {@link https://computing.qarnot.com/documentation/api/#api-Pool-Last_Task_Std_Out}
   * @memberof pools
   * @function
   * @name lastStdout
   * @param uuid {String} uuid of the pool
   ...
   * see: {@link https://computing.qarnot.com/documentation/api/#api-Pool-Task_Std_Err}
   * @memberof pools
   * @function
   * @name stderr
   * @param uuid {String} uuid of the pool
   ...
   * see: {@link https://computing.qarnot.com/documentation/api/#api-Pool-Task_Std_Out}
   * @memberof pools
   * @function
   * @name stdout
   * @param uuid {String} uuid of the pool
