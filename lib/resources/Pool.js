...
class Pool extends Resource {
  ...
  /**
   * see: {@link https://qarnot.com/documentation/api/#tag/Pools/paths/~1carbon~1v1~1Pools~1%7BpoolId%7D~1carbon-facts/get}
   * @name getCarbonFacts
   * @function
   * @memberof pools
   * @example <caption>Usage</caption>
   * const carbonFacts = await Qarnot.pools.getCarbonFacts(
   *   '00181edb-f156-4a06-a5af-54d503b5a7a0',
