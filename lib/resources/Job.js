...
class Job extends Resource {
   ...
   * see: {@link https://computing.qarnot.com/documentation/api/#api-Jobs-List_job_s_Tasks}
   * @function
   * @name get
   * @memberof jobs
   * @param uuid {String} uuid of the job
   ...
   * see: {@link https://computing.qarnot.com/documentation/api/#api-Jobs-Paginate_Jobs_List}
   * @function
   * @name paginate
   * @memberof jobs
   * @example <caption>Usage</caption>
   ...
   * @returns {Promise<Object[]>}
   */
  paginate(maximumResults = 20, nextToken = null, filter = null) {
    const pageBody = {
      Token: nextToken,
      Filter: filter,
