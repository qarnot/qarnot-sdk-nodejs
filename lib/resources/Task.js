...
class Task extends Resource {
  ...
  /** Error output of a specific task instance (can be rotated).<br>
   * see: {@link https://qarnot.com/documentation/api/#tag/Tasks/paths/~1v%7Bversion%7D~1tasks~1%7BtaskUuid%7D~1stderr~1%7BinstanceId%7D/get}
   * @memberof tasks
   * @function
   * @name instanceStderr
   * @param uuid {String} uuid of the task
   * @param instanceId {Number} id of the instance
   * @example <caption>Usage</caption>
   * const instanceStderr = await Qarnot.tasks.instanceStderr('00181edb-f156-4a06-a5af-54d503b5a7a0', 4);
   * console.log(instanceStderr);
   * @example <caption>Output</caption>
   * stderr from node 3!
   * @returns {Promise<String>}
   */
  instanceStderr(uuid, instanceId) {
    return this.httpClient.executeHttp('GET', `${this.baseURL}/${uuid}/stderr/${instanceId}`);
  }

  /** Standard output of a specific task instance (can be rotated).<br>
   * see: {@link https://qarnot.com/documentation/api/#tag/Tasks/paths/~1v%7Bversion%7D~1tasks~1%7BtaskUuid%7D~1stdout~1%7BinstanceId%7D/get}
   * @memberof tasks
   * @function
   * @name instanceStdout
   * @param uuid {String} uuid of the task
   * @param instanceId {Number} id of the instance
   * @example <caption>Usage</caption>
   * const instanceStdout = await Qarnot.tasks.instanceStdout('00181edb-f156-4a06-a5af-54d503b5a7a0', 4);
   * console.log(instanceStdout);
   * @example <caption>Output</caption>
   * hello world from node 3!
   * @returns {Promise<String>}
   */
  instanceStdout(uuid, instanceId) {
    return this.httpClient.executeHttp('GET', `${this.baseURL}/${uuid}/stdout/${instanceId}`);
  }
